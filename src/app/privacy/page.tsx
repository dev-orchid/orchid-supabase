...
export const metadata: Metadata = {
  ...
  description: "Learn how Orchid collects, uses, and protects your personal information.",
};
          ...
          <div className="prose prose-slate dark:prose-invert max-w-none">
            <section className="mb-8">
              ...
              <p className="mb-4 text-muted-foreground">
                At Orchid, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our services.
              </p>
              <p className="mb-4 text-muted-foreground">
